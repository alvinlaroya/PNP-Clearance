      ...
      <v-row>
        <v-col cols="12">
          <v-form ref="form" v-model="valid" lazy-validation>
            <v-card>
              <v-card-title class="ml-2">Update Applicant Record</v-card-title>
              <v-card-text>
                <v-container fluid>
                  <v-row>
                    <v-col cols="3">
...
export default {
  ...
  methods: {
    ...
    validate() {
      ...
      if (valid) {
        this.updateApplicant(this.clearance);
        this.snackbar = true;
        this.snackbarText = "Applicant Record Updated!";
